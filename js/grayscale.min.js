...
function init(){
  var e={
    zoom:15,center:box_loc,disableDefaultUI:!0,scrollwheel:!1,draggable:!1,
    styles:[{
  ...
  map=new google.maps.Map(t,e);var l="img/map-marker.png",o=box_loc;
  var z1=new google.maps.Marker({position:o,map:map,icon:l})
	new google.maps.InfoWindow({
      content: "<div class='mapsInfo'><a href='https://goo.gl/maps/2g5FDGER5Pp' target='_blank'>Avenida de Sequeiros, 31 RC/D<br/>Lodares, Lousada</a></div>"
	}).open(map,z1);
  google.maps.event.addListener(z1, 'click', function(){window.open('https://goo.gl/maps/2g5FDGER5Pp');});
}
